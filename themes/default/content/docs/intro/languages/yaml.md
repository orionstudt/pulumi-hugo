...
Further examples are given in the [Pulumi YAML GitHub repository][]. The specification for Pulumi
YAML documents is in the [Pulumi YAML reference]({{< relref "/docs/reference/yaml" >}}).

[Pulumi YAML GitHub repository]: https://github.com/pulumi/pulumi-yaml/tree/main/examples
